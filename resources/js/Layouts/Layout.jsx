...
const Layout = ({ children, notifications, user}) => {
    const { url } = usePage();
    ...
    return (
        <div className="flex h-screen bg-gray-100">
            ...
            >
                ...
                <span className="text-xl font-black font-serif text-blue-500 animate-pulse"> Dashboard</span>
                </div>
                <nav className="flex-1 p-2">
                    <div >
                        ...
                        <Link href="/users" className={`flex px-4 py-2 mt-2 text-sm ${url === '/users' ? 'bg-gray-700' : 'hover:bg-gray-700'}`}><UserIcon className='w5 h-5 mr-2'/>Users</Link>
